...
<head>
    ...
    <title>Admin Dashboard - e-RPH Mobile</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="main-content">
        <div class="header">
            <div>
                <div class="welcome-text">
                    Welcome back, <?php echo htmlspecialchars($admin_info['full_name']); ?>!
                </div>
                <div class="header-subtitle">Here is a simple overview of your system activity.</div>
            </div>
        ...
        <div class="stats-container fade-in-content">
            ...
            <div class="stat-card fade-in-card">
                ...
                <div class="stat-value" style="color: #14b8a6;">Active</div>
            </div>
        </div>

        <!-- Teacher Last Update Report -->
        <div class="recent-activity fade-in-content">
            <h3 class="section-title">Teacher Last Update Report</h3>
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        ";
                        $teacher_report_result = $conn->query($teacher_report_sql);
                        
                        if ($teacher_report_result && $teacher_report_result->num_rows > 0):
                            while ($teacher = $teacher_report_result->fetch_assoc()):
                        ?>
                        <tr class="fade-in-stagger">
                            <td><?php echo htmlspecialchars($teacher['teacher_name']); ?></td>
                            <td><?php echo $teacher['total_records']; ?></td>
                            <td>
                                <?php 
                                if ($teacher['last_update']) {
                                    echo date('M d, Y H:i', strtotime($teacher['last_update']));
                                } else {
                                    echo '<span class="text-muted">No records</span>';
                                }
                                ?>
                            </td>
                            <td>
                                ...
                                if ($teacher['status'] == 'active') {
                                    if ($teacher['last_update']) {
                                        $days_since_update = floor((time() - strtotime($teacher['last_update'])) / (60 * 60 * 24));
